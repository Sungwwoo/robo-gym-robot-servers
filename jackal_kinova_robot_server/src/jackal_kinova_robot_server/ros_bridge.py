...
class RosBridge:
    ...
    def get_state(self):
        ...
        state += base_position
        state += base_twist
        state_dict["pos_x"] = base_position[0]
        state_dict["pos_y"] = base_position[1]
        state_dict["lin_vel"] = base_twist[0]
        state_dict["ang_vel"] = base_twist[1]
    ...
    def set_state(self, state_msg):
        ...
        if not self.real_robot:
            ...
            self.set_model_state(self.ns + "_jackal_kinova", [pos_x, pos_y, 0])
    ...
    def get_topic(self, topic_name: str, type: str):
        try:
            msg = rospy.wait_for_message(topic_name, type)
            return msg
        except:
            rospy.loginfo("Error while getting topic")
    ...
    def callbackState(self, data):
        ...
        if self.reset.isSet():
            ...
            self.base_position = copy.deepcopy([x, y])
        else:
            pass
